...
export function AdventureHeader({ adventure, isGM, userRole, readOnly, onEdit, onDelete }: {
  readonly adventure: Adventure; readonly isGM: boolean; readonly userRole: string | null; readonly readOnly: boolean; readonly onEdit: () => void; readonly onDelete: () => void
}) {
        ...
        {isGM && (
          <div className="flex gap-2 shrink-0">
            <button
              ...
              className={`btn-ghost ${readOnly ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
