...
function EditForm(props: {
  ...
  hpActual: number; hpMax: number; hpNotes: string
    ...
    <form onSubmit={props.onSubmit} className="card !p-6 space-y-4 animate-slide-up">
      ...
      <div>
        ...
        <div className="grid gap-2 sm:grid-cols-3 mt-1">
          ...
          <div><label className="text-xs text-muted mb-1 block">Notes</label><input className="input-field" value={props.hpNotes} onChange={(e) => props.onHpNotesChange(e.target.value)} placeholder="e.g. 1d8 per level" /></div>
        </div>
      </div>
