...
function NewTemplateForm(props: {
  ...
  return <form onSubmit={props.onCreateTemplate} className="rounded-lg border border-primary/20 bg-background/50 p-4 space-y-3">
    ...
    <div className="rounded-lg border border-border/40 bg-background/20 p-3 space-y-2">
      <span className="text-xs font-semibold text-muted uppercase tracking-wider">Enable Features</span>
      <div className="flex flex-wrap gap-x-4 gap-y-2">
        <label className="flex items-center gap-1.5 text-xs text-foreground cursor-pointer"><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.newFeatureSkills} onChange={e => props.onNewFeatureSkillsChange(e.target.checked)} /><span>Skills</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Skills</p><p className="text-xs text-muted-foreground leading-relaxed">Define skills like Stealth, Perception, or Athletics. Players can assign values and roll against them.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
        <label className="flex items-center gap-1.5 text-xs text-foreground cursor-pointer"><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.newFeatureCustomFields} onChange={e => props.onNewFeatureCustomFieldsChange(e.target.checked)} /><span>Character Info</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Character Info</p><p className="text-xs text-muted-foreground leading-relaxed">Custom text fields for player details like Class, Race, or Background.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
        <label className="flex items-center gap-1.5 text-xs text-foreground cursor-pointer"><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.newFeatureCoreResources} onChange={e => props.onNewFeatureCoreResourcesChange(e.target.checked)} /><span>Core Resources</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Core Resources</p><p className="text-xs text-muted-foreground leading-relaxed">Trackable resources such as Health Points, Mana, or Stamina with player-editable values.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
        <label className="flex items-center gap-1.5 text-xs text-foreground cursor-pointer"><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.newFeatureArmorClass} onChange={e => props.onNewFeatureArmorClassChange(e.target.checked)} /><span>Armor Class</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Armor Class</p><p className="text-xs text-muted-foreground leading-relaxed">Configure armor calculations with components and attribute modifiers for AC determination.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
        <label className="flex items-center gap-1.5 text-xs text-foreground cursor-pointer"><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.newFeatureCharacterSections} onChange={e => props.onNewFeatureCharacterSectionsChange(e.target.checked)} /><span>Personal Abilities</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Personal Abilities</p><p className="text-xs text-muted-foreground leading-relaxed">Free-form sections like Talents, Traits, or Inventory for additional character details.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
        <label className={`flex items-center gap-1.5 text-xs cursor-pointer ${props.newFeatureSkills ? 'text-foreground' : 'text-muted cursor-not-allowed'}`}><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.newFeatureSkillProfiles} disabled={!props.newFeatureSkills} onChange={e => props.onNewFeatureSkillProfilesChange(e.target.checked)} /><span>Skill Profiles</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Skill Profiles</p><p className="text-xs text-muted-foreground leading-relaxed">Pre-configured modifier levels (e.g. Untrained, Expert, Master) that apply to skills. Requires Skills to be enabled.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
        <label className="flex items-center gap-1.5 text-xs text-foreground cursor-pointer"><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.newFeatureResistance} onChange={e => props.onNewFeatureResistanceChange(e.target.checked)} /><span>Resistance System</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Resistance System</p><p className="text-xs text-muted-foreground leading-relaxed">Define damage types and resistance/weakness calculations for characters.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
      </div>
    </div>
...
function TemplateRow(props: {
  ...
  if (props.isEditing) return <form onSubmit={props.onUpdate} className="rounded-lg border border-primary/30 bg-background/50 p-4 space-y-3">
    ...
    <div className="rounded-lg border border-border/40 bg-background/20 p-3 space-y-2">
      <span className="text-xs font-semibold text-muted uppercase tracking-wider">Enable Features</span>
      <div className="flex flex-wrap gap-x-4 gap-y-2">
        <label className="flex items-center gap-1.5 text-xs text-foreground cursor-pointer"><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.editFeatureSkills} onChange={e => props.onEditFeatureSkillsChange(e.target.checked)} /><span>Skills</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Skills</p><p className="text-xs text-muted-foreground leading-relaxed">Define skills like Stealth, Perception, or Athletics. Players can assign values and roll against them.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
        <label className="flex items-center gap-1.5 text-xs text-foreground cursor-pointer"><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.editFeatureCustomFields} onChange={e => props.onEditFeatureCustomFieldsChange(e.target.checked)} /><span>Character Info</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Character Info</p><p className="text-xs text-muted-foreground leading-relaxed">Custom text fields for player details like Class, Race, or Background.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
        <label className="flex items-center gap-1.5 text-xs text-foreground cursor-pointer"><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.editFeatureCoreResources} onChange={e => props.onEditFeatureCoreResourcesChange(e.target.checked)} /><span>Core Resources</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Core Resources</p><p className="text-xs text-muted-foreground leading-relaxed">Trackable resources such as Health Points, Mana, or Stamina with player-editable values.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
        <label className="flex items-center gap-1.5 text-xs text-foreground cursor-pointer"><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.editFeatureArmorClass} onChange={e => props.onEditFeatureArmorClassChange(e.target.checked)} /><span>Armor Class</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Armor Class</p><p className="text-xs text-muted-foreground leading-relaxed">Configure armor calculations with components and attribute modifiers for AC determination.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
        <label className="flex items-center gap-1.5 text-xs text-foreground cursor-pointer"><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.editFeatureCharacterSections} onChange={e => props.onEditFeatureCharacterSectionsChange(e.target.checked)} /><span>Personal Abilities</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Personal Abilities</p><p className="text-xs text-muted-foreground leading-relaxed">Free-form sections like Talents, Traits, or Inventory for additional character details.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
        <label className={`flex items-center gap-1.5 text-xs cursor-pointer ${props.editFeatureSkills ? 'text-foreground' : 'text-muted cursor-not-allowed'}`}><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.editFeatureSkillProfiles} disabled={!props.editFeatureSkills} onChange={e => props.onEditFeatureSkillProfilesChange(e.target.checked)} /><span>Skill Profiles</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Skill Profiles</p><p className="text-xs text-muted-foreground leading-relaxed">Pre-configured modifier levels (e.g. Untrained, Expert, Master) that apply to skills. Requires Skills to be enabled.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
        <label className="flex items-center gap-1.5 text-xs text-foreground cursor-pointer"><input type="checkbox" className="w-3 h-3 rounded accent-primary" checked={props.editFeatureResistance} onChange={e => props.onEditFeatureResistanceChange(e.target.checked)} /><span>Resistance System</span><MythrionPopover side="top" align="center" sideOffset={4} content={<div className="space-y-1"><p className="text-xs font-semibold text-foreground">Resistance System</p><p className="text-xs text-muted-foreground leading-relaxed">Define damage types and resistance/weakness calculations for characters.</p></div>}><span className="inline-flex items-center justify-center w-3.5 h-3.5 rounded-full text-[0.55rem] font-bold text-muted-foreground border border-border/60 cursor-help hover:text-foreground hover:border-foreground/40 transition-colors">?</span></MythrionPopover></label>
      </div>
    </div>
    <div className="flex gap-1 flex-wrap">
