    ...
    <main className="min-h-screen bg-background text-foreground px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl space-y-6">
        <div className="flex items-center justify-between gap-4">
            <div>
              <p className="text-sm uppercase tracking-[0.25em] text-muted">{t('legal:privacyTitle')}</p>
              <h1 className="mt-3 text-3xl font-semibold text-foreground">{t('legal:privacyTitle')}</h1>
            </div>
